...
Советуем модель `deepseek/deepseek-v4-flash-0731`. Проверено на игре.
...
2. **Загрузи правила.** В разделе **«Настройка AI мастера»** два пути:
   ...
   - **Своё** — загрузи архив `*.zip` из Markdown-файлов (или одиночный `.md`), Builder сам разберёт структуру и наполнит глоссарий и «мозг». Это может занять время и потребовать настройки — перед стартом стоит потестировать на нескольких играх.
